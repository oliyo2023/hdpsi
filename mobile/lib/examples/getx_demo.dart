...
class GetXDemoScreen extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Obx(() {
                      final controller = Get.find<MemberController>(tag: 'member_controller');
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          if (controller.error != null)
                            Text('错误: ${controller.error}', style: const TextStyle(color: Colors.red)),
                        ],
                      );
                    }),
                  ],
  ...
  void _checkControllerStatus() {
    final isRegistered = Get.isRegistered<MemberController>(tag: 'member_controller');
