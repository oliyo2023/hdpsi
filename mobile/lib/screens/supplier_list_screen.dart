...
class _SupplierListScreenState extends State<SupplierListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _supplierController.fetchSuppliers();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (_supplierController.isLoading) {
        ...
        } else if (_supplierController.hasError) {
          return ErrorDisplay(
            error: _supplierController.error,
            onRetry: () => _supplierController.fetchSuppliers(),
          );
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final supplier = _supplierController.suppliers[index];
              return Card(
