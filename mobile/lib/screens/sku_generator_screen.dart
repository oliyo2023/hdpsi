...
class _SkuGeneratorScreenState extends State<SkuGeneratorScreen> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('生成SKU失败: ${e.toString()}')),
        );
      }
    }
  }
  ...
  void _copySku() {
    if (_generatedSku != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('SKU已复制到剪贴板')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          // 动画顶部
          const AnimatedHeader(title: 'SKU生成器', height: 120.0),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              ...
                              style: TextStyle(fontSize: AppTheme.fontSizeSmall, color: Colors.grey),
                            ),
                          ],
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              value: _season,
                              items: _seasonOptions.map((option) {
                                return DropdownMenuItem(
                                  value: option['value'],
