...
class ModelsInventoryProductVariant {
  /// Returns a new [ModelsInventoryProductVariant] instance.
  ModelsInventoryProductVariant({
    this.barcode,
    this.color,
    this.colorID,
    this.costPrice,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ModelsInventoryProductVariant &&
  ...
  /// Returns a new [ModelsInventoryProductVariant] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ModelsInventoryProductVariant? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ModelsInventoryProductVariant[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ModelsInventoryProductVariant[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ModelsInventoryProductVariant(
  ...
  static List<ModelsInventoryProductVariant> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ModelsInventoryProductVariant>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ModelsInventoryProductVariant.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ModelsInventoryProductVariant> mapFromJson(dynamic json) {
    final map = <String, ModelsInventoryProductVariant>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ModelsInventoryProductVariant.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ModelsInventoryProductVariant-objects as value to a dart map
  static Map<String, List<ModelsInventoryProductVariant>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ModelsInventoryProductVariant>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ModelsInventoryProductVariant.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
