...
String parameterToString(dynamic value) {
  ...
  if (value is ModelsConsumptionLevel) {
    return ModelsConsumptionLevelTypeTransformer().encode(value).toString();
  }
  if (value is ModelsMemberLevel) {
    return ModelsMemberLevelTypeTransformer().encode(value).toString();
  }
  if (value is ModelsStylePreference) {
    return ModelsStylePreferenceTypeTransformer().encode(value).toString();
  }
  if (value is ModelsSupplierRating) {
    return ModelsSupplierRatingTypeTransformer().encode(value).toString();
  }
  if (value is ModelsSupplierType) {
    return ModelsSupplierTypeTypeTransformer().encode(value).toString();
  }
