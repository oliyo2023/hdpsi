  ...
  Future<bool> _refreshToken() async {
    try {
      ...
      if (response.statusCode == 200) {
        await _secureStorage.write(key: AppConfig.tokenKey, value: response.data['token']);
        await _secureStorage.write(key: AppConfig.refreshTokenKey, value: response.data['refresh_token']);
        return true;
      }
      return false;
    } catch (e) {
